/*//////////////////////////////// NOTES \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\*\
  ...
  draggable plugin for svgdotjs
  copied from https://github.com/svgdotjs/svg.draggable.js
  so we can debug more efficiently
...
/**
 * Add the 'draggable' method to the Element class if it doesn't
 * already exist, then initialize it by default. Call draggable(false)
 * to disable dragging.
 *
 */
extend(Element, {
